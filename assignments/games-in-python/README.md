...
Create a Hangman game that randomly selects words from a predefined list and allows players to guess letters to reveal the hidden word before exhausting their allowed attempts.
